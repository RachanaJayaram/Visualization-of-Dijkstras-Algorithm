...
def dijkstra(graph,queue):
     ...
     print(queue.sort())
     while queue.length:
          step={"dist":dist.copy(),"min_dist_router":queue.sort()[0][1],"queue":queue.sort()[:],"adjacent_nodes":None,"adj_node":None,"old_dist":None,"dist_with":None,"new_dist":None,"settled":settled.copy()}
     ...
     step={"dist":dist.copy(),"min_dist_router":None,"queue":queue.sort()[:],"adjacent_nodes":None,"adj_node":None,"old_dist":None,"dist_with":None,"new_dist":None,"settled":settled.copy()}
