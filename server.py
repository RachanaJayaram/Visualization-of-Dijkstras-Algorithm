...
def webInterface(): 
	...
	# print(result,input_graph)
	# print(steps)
	return render_template('Dijkstras.html',result=result,input_graph=input_graph) #using jinja2 to render Dijkstars.html template at this url
...
# @app.route('/Dijkstras_post', methods=['POST'])
